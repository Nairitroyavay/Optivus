...
abstract final class DiagnosticCodes {
  ...
  static const String validationMissingTimetable = 'VALIDATION_MISSING_TIMETABLE';
  ...
  static const String verifyEmailSessionExpired = 'VERIFY_EMAIL_SESSION_EXPIRED';
  ...
  static const String aiNutritionResponseInvalid = 'AI_NUTRITION_RESPONSE_INVALID';
  static const String aiSkinCareResponseInvalid = 'AI_SKIN_CARE_RESPONSE_INVALID';
  ...
  // Cloud Persistence
  static const String firestoreDraftWriteFailed = 'FIRESTORE_DRAFT_WRITE_FAILED';
  static const String firestoreProfileWriteFailed = 'FIRESTORE_PROFILE_WRITE_FAILED';
  ...
  // Conflict
  static const String timelineUnresolvedConflict = 'TIMELINE_UNRESOLVED_CONFLICT';
  static const String scheduleOverlapDecisionNeeded = 'SCHEDULE_OVERLAP_DECISION_NEEDED';
  ...
  static const String recoveryMissingCurrentRun = 'RECOVERY_MISSING_CURRENT_RUN';
  static const String recoveryDanglingRunReference = 'RECOVERY_DANGLING_RUN_REFERENCE';
  static const String recoveryDurableStateConflict = 'RECOVERY_DURABLE_STATE_CONFLICT';
  static const String recoveryInvalidCompletionBundle = 'RECOVERY_INVALID_COMPLETION_BUNDLE';
  ...
  static const String completionRoutineAccountingFailed = 'COMPLETION_ROUTINE_ACCOUNTING_FAILED';
  static const String completionHabitReadbackFailed = 'COMPLETION_HABIT_READBACK_FAILED';
  static const String completionTerminalizationPending = 'COMPLETION_TERMINALIZATION_PENDING';
