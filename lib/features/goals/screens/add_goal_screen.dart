              ...
              if (isLimitReached) ...[
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(
                    labelText: 'Identity Title (e.g., Sleek Coder)',
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(
                    labelText: 'Purpose statement (Why?)',
                    border: OutlineInputBorder(),
                  ),
                ),
                const SizedBox(height: 12),
                TextField(
                  ...
                  decoration: const InputDecoration(
                    labelText: 'Daily proof action (standard version)',
                    border: OutlineInputBorder(),
                  ),
                ),
                const SizedBox(height: 20),
                    ...
                    onPressed: isLimitReached
                        ...
                        : () {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                content: Text('Sleek Identity Focus Added!'),
