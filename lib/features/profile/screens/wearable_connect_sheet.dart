// Legacy Profile sheet. Active service controls live in ConnectedServicesScreen.
import 'dart:async';
              ...
              child: Column(
                children: [
                  SwitchListTile.adaptive(
                    ...
                    subtitle: const Text(
                      'Read dynamic active steps & calorie metrics',
                  ...
                  SwitchListTile.adaptive(
                    ...
                    subtitle: const Text(
                      'Read resting heart rate & sleep staging',
                      style: TextStyle(fontSize: 10),
                    ),
                    value:
                        permissions.locationGps ==
                        PermissionConnectionState.mockConnected,
                    onChanged: (val) {
                      ref
                          .read(mockPermissionProvider.notifier)
                          .toggleLocationGpsPermission();
                    },
                  ),
                ],
              ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          SizedBox(height: 12),
                          Text(
                            'Aggregating hardware steps & heart rate streams...',
                            style: TextStyle(
                              fontSize: 11,
                  ...
                  return LiquidGlassPanel(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text(
                          '• Raw Steps Collected: 12,456 steps',
                          style: TextStyle(
                            fontSize: 11,
                            fontWeight: FontWeight.bold,
                          ),
                        ...
                        const Text(
                          '• Avg HR: 72 BPM | Heart rate variability: 62 ms',
                          style: TextStyle(
                            fontSize: 11,
                            fontWeight: FontWeight.bold,
                          ),
                        ...
                        const Text(
                          '• Total Active Calories: 482 kcal',
                          style: TextStyle(
                            fontSize: 11,
                            fontWeight: FontWeight.bold,
                          ),
                        ...
                        const Text(
                          '• Deep Sleep Sleep staging: 2h 45m',
                          style: TextStyle(
                            fontSize: 11,
                            fontWeight: FontWeight.bold,
                          ),
