...
class HomeChoiceTile extends StatelessWidget {
  final String title;
  final String? subtitle;
  final IconData icon;
  final bool selected;
  ...
  const HomeChoiceTile({
    ...
    this.onTap,
    this.accent = const Color(0xFFF36F78),
    this.trailing,
...
class HomeIconPill extends StatelessWidget {
  final IconData icon;
  final VoidCallback? onTap;
  final Color accent;
...
class HomeDayDroplet extends StatelessWidget {
  final String label;
  final bool selected;
  final Color color;
  final VoidCallback? onTap;

  const HomeDayDroplet({
    super.key,
    required this.label,
    required this.selected,
    required this.color,
...
class HomeLiquidToggle extends StatelessWidget {
  final bool value;
  final ValueChanged<bool> onChanged;
  final Color accent;

  const HomeLiquidToggle({
    super.key,
    required this.value,
...
class HomeLiquidSlider extends StatefulWidget {
  final List<String> options;
  final String selectedValue;
  final ValueChanged<String> onChanged;
  final Color accent;

  const HomeLiquidSlider({
    super.key,
  ...
  @override
  State<HomeLiquidSlider> createState() => _HomeLiquidSliderState();
}

class _HomeLiquidSliderState extends State<HomeLiquidSlider> {
...
class HomeUnitToggle extends StatelessWidget {
  final String option1;
  final String option2;
  final bool isOption1;
  final ValueChanged<bool> onChanged;

  const HomeUnitToggle({
    super.key,
            ...
            Positioned.fill(
              child: AnimatedAlign(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: const Color(0xFFF36F78).withValues(alpha: 0.9),
...
class HomeLiquidContinuousSlider extends StatefulWidget {
  final double value;
  ...
  const HomeLiquidContinuousSlider({
    super.key,
    required this.value,
  ...
  @override
  State<HomeLiquidContinuousSlider> createState() =>
      _HomeLiquidContinuousSliderState();
}

class _HomeLiquidContinuousSliderState
    extends State<HomeLiquidContinuousSlider> {
