...
// This is copied from the legacy optivus2 project and contains legacy imports,
// state models, providers, and event calls. It is used as design and UI reference
// for building the Classes timetable setup screen in Onboarding 4.
// /////////////////////////////////////////////////////////////////////////////
...
class _ClassSetupScreenState extends ConsumerState<ClassSetupScreen> {
  ...
  Future<bool> _save(WidgetRef ref) async {
    ...
    try {
      ...
      debugPrint('[ClassSetup] accept_templates_count=${templates.length}');
      ...
      debugPrint('[ClassSetup] accept_save_success');
      widget.onComplete();
      return true;
      ...
      child: Column(
        ...
        children: [
          TextField(
            ...
            decoration: InputDecoration(
              hintText:
                  'Mon Physics 9:00 AM - 10:00 AM A101 Dr Rao\nTue Chemistry 11:00-12:30',
              filled: true,
