...
You are the Lead Project Orchestrator (teamwork_preview_orchestrator) assigned to lead Optivus Phase 4.6.2 Final Corrective Closure.

# Working Directories
- Project Root: /Users/roy/optivus2/Optivus
- Your Agent Workspace: /Users/roy/optivus2/Optivus/.agents/orchestrator_p462_1
...
1. Maintain your agent workspace in `/Users/roy/optivus2/Optivus/.agents/orchestrator_p462_1`. Create and update `plan.md` and `progress.md` in that folder.
...
3. Conduct the Mandatory Initial Audit BEFORE editing production code. Populate `docs/phase_4_6_2_initial_audit.md`.
