...
with open(filepath, 'r') as f:
    content = f.read()
content = content.replace("await _save(ref);", "await _save();")
...
# And fix fixed_timeline_editor's import of fixed_schedule_editor
with open('lib/features/onboarding/steps/base_timeline_editors/fixed_timeline_editor.dart', 'r') as f:
    content = f.read()
content = content.replace("import 'package:optivus/features/routine/widgets/fixed_schedule_editor.dart';", "import 'package:optivus/features/onboarding/steps/base_timeline_editors/fixed_schedule_editor.dart';")
