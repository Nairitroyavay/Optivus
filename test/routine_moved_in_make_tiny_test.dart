...
void main() {
  group('Gate N: Moved-In Occurrence Make Tiny Contract', () {
    ...
    test(
      'Moved-in occurrence Make Tiny retains source occurrenceDate and targets displayDate',
      () async {
    ...
    test(
      'Make tiny directly preserves template duration seed when invoked on repeated weekly item',
      () async {
