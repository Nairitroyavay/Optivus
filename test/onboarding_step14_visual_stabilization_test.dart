  ...
  group('Step 14 Visual Stabilization Regression Suite', () {
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        final initialOffstageId =
            isCardContentOffstage('office') ? 'office' : 'meeting';
        final initialVisibleId =
            initialOffstageId == 'office' ? 'meeting' : 'office';
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        expect(focusedWorkCard.left, prepared.leftOffset + prepared.gutterWidth);
