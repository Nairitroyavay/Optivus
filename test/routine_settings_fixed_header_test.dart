...
void main() {
  group('LiquidDetailScaffold fixedHeader', () {
    testWidgets('when fixedHeader is true, header position remains stationary on scroll', (tester) async {
    ...
    testWidgets('when fixedHeader is false, header scrolls with content', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: LiquidDetailScaffold(
      ...
      final scrolledHeaderPos = tester.getTopLeft(find.text('Scrolling Header'));
  ...
  group('RoutineTab Routine Settings fixed header', () {
    testWidgets('header in routine settings is fixed while scrolling and back button returns to timeline', (tester) async {
      ...
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
            ...
            routineTransactionRepositoryProvider.overrideWithValue(FakeRoutineTransactionRepository()),
          ],
