...
void main() {
  group('Onboarding 5 Dish Extraction Mapping and UI', () {
    ...
    testWidgets('renders +N more when available height is restricted and long dishes cause overflow', (tester) async {
      final draft = OnboardingDraft(
        baseTimeline: BaseTimelineDraft(
          eatingSetupStep: 1,
          eatingSetupPath: 'create',
      ...
      expect(find.text('First Extremely Long Dish Name That Takes Space'), findsWidgets);
      expect(find.text('Eighth Extremely Long Dish Name That Takes Space'), findsWidgets);
    });
  });
}
