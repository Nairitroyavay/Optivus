...
void main() {
  group('Gate F: Weekly Free Slot Edge Cases & Sleep Explanation', () {
    ...
    test(
      'findWeeklyFreeSlot across 7 days finds mutually free common slot',
      () {
    ...
    test(
      'findWeeklyFreeSlot with empty repeatDays delegates to findFreeSlot for baseDate',
      () {
    ...
    test(
      'findWeeklyFreeSlot with duration exceeding entire 17-hour window returns null',
      () {
        final slot = notifier.findWeeklyFreeSlot(
          item: RoutineItem(
            id: 'mammoth_task',
          ...
          durationMinutes:
              18 * 60, // 18 hours (window is 17 hours: 6 AM to 11 PM)
          baseDate: DateTime(2026, 9, 14),
        );
    ...
    testWidgets(
      'AddRoutineSheet shows helpful Sleep explanation when slot not found',
      (tester) async {
