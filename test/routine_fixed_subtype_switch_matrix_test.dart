...
void main() {
  group('Gate D: Fixed Subtype Switch Matrix (4x4 + Sleep/Travel/Bath/Other)', () {
    test('Class -> Work -> Eating -> Skin Care -> Class complete zero-leakage cycle', () {
      // Start with Class
    ...
    test('Transitions to and from Sleep, Travel, Bath, Other clear all specific subtype state', () {
    ...
    test('AddRoutineMapper correctly translates subtype fields to RoutineItem', () {
      ...
      final skinDraft = AddRoutineDraft.initial(
        ...
        fixedState: const AddRoutineFixedState(
          ...
          steps: ['Wash face', 'Apply Vitamin C', 'Moisturize', 'Sunscreen'],
          skincareProducts: ['Cleanser', 'Serum', 'SPF 50'],
        ),
      );
      final skinItem = AddRoutineMapper.toRoutineItem(skinDraft);
      expect(skinItem.steps, ['Wash face', 'Apply Vitamin C', 'Moisturize', 'Sunscreen']);
