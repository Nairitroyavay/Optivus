...
void main() {
  group('Onboarding Role Change State Safety', () {
    test('updateLifeRoleSelection clears class and work data when role removes them', () {
      ...
      final warnings = notifier.updateLifeRoleSelection(LifeRoleDraft.notStudentNotWorkingKey);
