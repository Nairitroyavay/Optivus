...
void main() {
  group('Gates G, H, I, J, K, P: Contextual Actions & Accessible Responsive Layout', () {
    ...
    testWidgets('Gate G & H: Money task shows 3 actions (Save money + Move + Skip), never Done', (tester) async {
    ...
    testWidgets('Gate I: Bad-habit Check-in shows 3 actions (Check in + Move + Skip), never Done', (tester) async {
    ...
    testWidgets('Gate J: Planned Tracker Task shows 3 actions (Start Tracker + Move + Skip), never Done', (tester) async {
    ...
    testWidgets('Standard Planned Task shows 4 actions (Start + Done + Move + Skip)', (tester) async {
      ...
      expect(find.text('Move'), findsOneWidget);
      expect(find.text('Skip'), findsOneWidget);
      expect(find.byKey(const ValueKey('routine-action-row-horizontal')), findsOneWidget);
    });

    testWidgets('Standard Planned Task shows grid-2x2 layout when horizontal row does not fit', (tester) async {
      final standardItem = RoutineItem(
        id: 'standard_grid_1',
        title: 'Read Physics',
        blockType: RoutineBlockType.flexibleTask,
      ...
      expect(find.text('Move'), findsOneWidget);
      expect(find.text('Skip'), findsOneWidget);
      expect(find.byKey(const ValueKey('routine-action-grid-2x2')), findsOneWidget);
    });
    ...
    test('Gate P: Measurement parity between resolveRoutineCardActionLayout and actionFooterHeight', () {
      ...
      final layout3Money = RoutineCardPresentation.resolveRoutineCardActionLayout(
