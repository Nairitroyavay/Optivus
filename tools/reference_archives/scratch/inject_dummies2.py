...
os.system("mkdir -p lib/features/onboarding/steps/base_timeline_editors/legacy_models")
os.system("cp reference_copied_old_frontend/onboarding_base_timeline/shared_models_or_enums/*.dart lib/features/onboarding/steps/base_timeline_editors/legacy_models/")
os.system("sed -i '' 's/package:optivus2\\//package:optivus\\//g' lib/features/onboarding/steps/base_timeline_editors/legacy_models/*.dart")
